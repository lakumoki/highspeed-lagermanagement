...
router.post('/', (req, res) => {
  ...
  db.prepare('INSERT INTO bewegungen (kunde_id, datum, typ, anzahl, paletten_nummern, benutzer, monat) VALUES (?, ?, ?, 1, ?, ?, ?)').run(palette.kunde_id, heute, 'Auslagerung', paletten_nr, benutzer, heute.substring(0, 7));
